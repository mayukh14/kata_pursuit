...
WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Blue Jeans/input_Qty_button-2 add-to-compare-list-button'))

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Compare Products/input_Compare products_button-2 remove-button'))

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Compare Products/a_Log out'))
