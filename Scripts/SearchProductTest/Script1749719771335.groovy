...
WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Search/a_Blue Jeans'))

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Blue Jeans/a_Log out'))
