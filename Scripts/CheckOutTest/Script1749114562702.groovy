...
WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Checkout/input__button-1 new-address-next-step-button'))
...
WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Checkout/input__button-1 payment-method-next-step-button'))

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Checkout/input__button-1 payment-info-next-step-button'))

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Checkout/input__button-1 confirm-order-next-step-button'))
