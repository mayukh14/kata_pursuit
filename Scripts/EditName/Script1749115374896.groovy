...
WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop/a_My account'))

WebUI.setText(findTestObject('Object Repository/Page_Demo Web Shop. Account/input_Last name_LastName'), 'Chakraborty 2')

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Account/input__save-info-button'))
